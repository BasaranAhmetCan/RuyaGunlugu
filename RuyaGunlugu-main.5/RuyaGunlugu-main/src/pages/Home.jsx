                  ...
                  <AnimatePresence>
                    {dreamText.trim().length > 0 && (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={handleSave}
                        className="absolute bottom-4 right-4 w-12 h-12 bg-gradient-to-tr from-[#7C3AED] to-[#8B5CF6] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(139,92,246,0.4)] text-white always-white"
                      >
