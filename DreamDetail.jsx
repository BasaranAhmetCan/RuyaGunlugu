...
const DreamDetail = () => {
  ...
  const getMeaning = () => {
    switch (activeTab) {
      case 'classic': return dream.classicMeaning || dream.classic_meaning || "Bu perspektifte yorum bulunamadı.";
      case 'freud': return dream.freudMeaning || dream.freud_meaning || "Bilinçaltı analizi yüklenemedi.";
      case 'jung': return dream.jungMeaning || dream.jung_meaning || "Arketip analizi yüklenemedi.";
      case 'islamic': return dream.islamicMeaning || dream.islamic_meaning || "Geleneksel yorum yüklenemedi.";
      case 'astrological': return dream.astrologicalMeaning || dream.astrological_meaning || "Astrolojik analiz yüklenemedi.";
    ...
    <div className="p-6 max-w-2xl mx-auto text-white min-h-screen bg-slate-900">
      ...
      {dream.imageUrl && (
        <div className="mb-6 rounded-xl overflow-hidden border border-slate-700">
          <img src={dream.imageUrl} alt="Rüya Görseli" className="w-full h-64 object-cover" />
        </div>
      )}
