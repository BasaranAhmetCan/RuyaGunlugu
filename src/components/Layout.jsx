...
import { Mic, Calendar, BarChart2, AlarmClock, Sparkles, Sun, Moon } from 'lucide-react';
      ...
      <nav className="fixed bottom-0 left-0 w-full h-20 bg-dream-mid/80 backdrop-blur-lg border-t border-white/5 flex justify-center items-center z-50 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
        <div className="flex justify-between items-center w-full max-w-md px-4">
          ...
          <motion.button
            whileTap={{ scale: 0.85 }}
            onClick={toggleTheme}
            className="flex flex-col items-center gap-1 text-white/40 hover:text-dream-accent transition-all duration-300"
